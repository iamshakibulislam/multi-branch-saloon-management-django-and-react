...
<div className="sliderfull">
  <div id="rev_slider_4_1_wrapper" className="rev_slider_wrapper fullwidthbanner-container" data-alias="classicslider1" style={{margin:'0px auto',backgroundColor:'transparent',padding:'0px',marginTop:'0px',marginBottom:'0px'}}> 
    ...
    <div id="rev_slider_4_1" className="rev_slider fullwidthabanner" style={{display:'none'}} data-version="5.0.7">
      ...
      <div className="tp-bannertimer" style={{height: '7px', backgroundColor: '#ffffff' }}></div>
    </div>
  </div>
</div>
<section className="slider-titile">
          ...
          <div className="responsive">
            <div> 
              <div className="third-effect">
              	<img src="http://www.placehold.it/384x444" className="img-responsive" alt="Our Team"/>
                <div className="mask">
					<a href="#">Facebook</a>
    ...
    <div className="container">
      ...
      <div className="row marbottom wow fadeInUp">
        <div className="col-sm-12 col-md-7 col-lg-7 col-padright-none">
          ...
          <img src="http://www.placehold.it/684x394" className="img-responsive" alt="cutting"/> 
         </div>
      ...
      <div className="row marbottom wow fadeInUp">
        <div className="col-sm-12 col-md-7 col-lg-7 col-padleft-none displayhide">
          ...
          <img src="http://www.placehold.it/684x394" className="img-responsive" alt="Colour"/> </div>
      ...
      <div className="row wow fadeInUp">
        <div className="col-sm-12 col-md-7 col-lg-7 col-padright-none">
          ...
          <img src="http://www.placehold.it/684x394" className="img-responsive" alt="Style"/> </div>
        <div className="col-sm-12 col-md-5 col-lg-5 col-padleft-none">
          <table className="table table-bordered table-striped">
            <thead>
              <tr>
    ...
    <div className="container">
      <div className="row">
        ...
        <div className="portfoliodiv">
          <div className="col-25 coloring manucuring"> <a className="fancybox" href="images/gallery/large/280x375.png" data-fancybox-group="gallery">
            <div className="hover"> 
          ...
          <div className="col-25 Wcut manucuring"> <a className="fancybox" href="images/gallery/large/280x375.png" data-fancybox-group="gallery">
            <div className="hover"> 
            <img src="http://www.placehold.it/280x450" alt="Portfolio"/>
              <div className="mask-img">
               	<div className="hvrlink">
              	<h3>Style</h3>
                <p>Lorem Ipsum is simply dummy text of the printing industry.</p>
          ...
          <div className="col-25 coloring Hspa"> <a className="fancybox" href="images/gallery/large/280x375.png" data-fancybox-group="gallery">
            <div className="hover"> 
            <img src="http://www.placehold.it/280x375" alt="Portfolio"/>
              <div className="mask-img">
               	<div className="hvrlink">
          ...
          <div className="col-25 Wcut"> <a className="fancybox" href="images/gallery/large/280x375.png" data-fancybox-group="gallery">
            <div className="hover"> 
            <img src="http://www.placehold.it/280x450" alt="Portfolio"/>
              <div className="mask-img">
               	<div className="hvrlink">
          ...
          <div className="col-25 coloring"> <a className="fancybox" href="images/gallery/large/280x375.png" data-fancybox-group="gallery">
            <div className="hover"> 
            <img src="http://www.placehold.it/280x375" alt="Portfolio"/>
              <div className="mask-img">
               	<div className="hvrlink">
          ...
          <div className="col-25 Bspa"> <a className="fancybox" href="images/gallery/large/280x375.png" data-fancybox-group="gallery">
            <div className="hover"> 
            <img src="http://www.placehold.it/280x375" alt="Portfolio"/>
              <div className="mask-img">
               	<div className="hvrlink">
          ...
          <div className="col-25"> <a className="fancybox" href="images/gallery/large/280x375.png" data-fancybox-group="gallery">
            <div className="hover"> 
            <img src="http://www.placehold.it/280x375" alt="Portfolio"/>
              <div className="mask-img">
               	<div className="hvrlink">
              ...
              <div id="myCarousel-1" className="carousel slide" data-ride="carousel">
                <div className="carousel-inner" role="listbox">
                  <div className="item active">
                    <div className="img-right"><img src="http://www.placehold.it/713x400" alt="First slide" className="img-responsive"/></div>
                ...
                <div className="carousel-control"> <a className="left" href="#myCarousel-1" role="button" data-slide="prev"></a> <a className="right" href="#myCarousel-1" role="button" data-slide="next"></a> </div>
              </div>
            </div>
            <div className="clearfix"></div>
          </div>
    ...
    <div className="container">
        <div className="testimonilabg">
            ...
            <div id="myCarousel-2" className="carousel slide" data-ride="carousel">
                <div className="carousel-inner" role="listbox">
                  <div className="item active">
                    <div className="img-left"><img src="http://www.placehold.it/150x150" alt="Testimonial" className="img-responsive"/></div>
                ...
                <div className="carousel-control"> <a className="left" href="#myCarousel-2" role="button" data-slide="prev"></a> <a className="right" href="#myCarousel-2" role="button" data-slide="next"></a> </div>
              </div>
        </div>
    </div>
  </section>
      ...
      <div className="row">
        ...
        <div className="col-sm-12 col-md-8 col-lg-8">
          <div className="contactmap">
            <div className="mapcont">
              <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d25216.227802888236!2d144.956981!3d-37.812802!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad65d4e793770d3%3A0x9e44d6ad0d76ba7c!2s121+King+St%2C+Melbourne+VIC+3000%2C+Australia!5e0!3m2!1sen!2sus!4v1429013152809" style={{border:'0px'}}></iframe>
            </div>
            <div className="social">
              <p>121 King Street, Melbourne Victoria 3000 Australia</p>
              <span>Phone - +61 0 0000 0000s </span> <span>Email - <a href="mailto:info@websitec.com">info@blackair.com</a></span>
              <div className="social-icon"> <a href="#" className="facebook"></a> <a href="#" className="twitter"></a> <a href="#" className="google"></a> <a href="#" className="youtube"></a> </div>
            </div>
            <div className="clearfix"></div>
          </div>
        </div>
        <div className="col-sm-12 col-md-4 col-lg-4 pull-right">
          ...
          <form name="ContactForm" id="ContactForm" method="post">
            ...
            <div className="form-group pull-left">
              <input type="text" className="form-control required number" name="ContactNumber" id="ContactNumber" placeholder="Conatct Number"  />
            </div>
            <div className="form-group pull-left marright0">
  ...
  <a href="#" className="scrollup">Top</a>
</div>
